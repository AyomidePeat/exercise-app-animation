...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        backgroundColor:
            Colors.transparent, // Color.fromARGB(31, 179, 140, 140),
        ...
        body: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const SizedBox(),
                        SmallButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>ChallengeListScreen()));
                        },
            ...
            CustomContainer(
                ...
                .animate()
                .then(delay: 1000.ms)
                .slideY(begin: 3, duration: 2000.ms),
            SizedBox(
              height: 168,
              child: Stack(
